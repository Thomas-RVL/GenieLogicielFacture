...
public class FactureTest {
    ...
    public void setUp() {
        ...
        Date dateDuJour = new Date(2017,12,8);
    ...
    public void testGetter() {
        ...
        assertEquals(new Date(2017,12,8), f.getEmission());
        ...
        LigneFacture lf = new LigneFacture(4, f, disk, 0.1f);
        assertEquals(4, lf.getNombre());
        assertEquals(f, lf.getFigureDans());
        assertEquals(disk, lf.getArticleFacture());
        assertEquals(0.1, lf.getTauxRemise(), 0.1);
